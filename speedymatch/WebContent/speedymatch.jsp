...
<title>Welcome To Speedy Match</title>
...
<body class="docs uikit" id="inner-doc">
	...
	<section class="nine columns push_one" id="docs-content">
		...
		<div class="left-center">
			...
			<!-- 	<div id="ageValidation">
	<h5>Are you above 18?</h5>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<div class="medium success btn"><a href="homepage.html">Yes</a></div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<div class="medium danger btn"><a href="#">No</a></div>
	</div> -->
